...
# Create table
CREATE TABLE IF NOT EXISTS `streets_SUFFIX`.`STREET_DETAILS` (`ITEM_ID` INT NOT NULL AUTO_INCREMENT PRIMARY KEY, `NAME` TEXT NOT NULL, `NAME_BASE` TEXT NOT NULL, `NAME_TYPE` TEXT NOT NULL, `STREET_TYPE` TEXT NOT NULL, `STREET_LEVEL` INT NULL, `POLYLINE` LONGTEXT NOT NULL, `WAY_IDS` TEXT NOT NULL, `NUM_WAYS` INT NOT NULL, `PROCESSED` TINYINT(1) NULL, `SKIP` TINYINT(1) NULL);
