...
def ExtractNameBase(name):	
	...
	streetTypes = [
		"Street", "Drive","Way","Lane","Road","Freeway","Highway","Expressway","Alley",
		"Terrace","Court","Boulevard","Avenue","Place","Skyway","Parkway","Square","Plaza",
		"Park","Bridge","Crescent","Pike","Mall","Tollway","Circle","Loop","Walk",
		"Tunnel","Row","Gardens","Trail","Grove","Mews","Close","Crescent","Rise","Yard","Villas",
		"St","Dr","Ln","Rd","Fwy","Expy","Hwy","Ter","Ct","Blvd","Ave","Pl","Pky","Pkwy","Sq","Br",
	]
	allTypesREString = ' ({})$'.format("|".join(streetTypes))

	if not re.search(allTypesREString,name):
			return ''

	return re.sub(allTypesREString, '', name)
